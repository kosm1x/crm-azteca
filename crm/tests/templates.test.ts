...
describe("global.md -- tool coverage", () => {
  ...
  it("references all 46 tool names", () => {
    expect(allToolNames.size).toBe(46); // unique tool names across all roles
...
describe("manager.md -- tool references", () => {
  ...
  it("references all 29 gerente tools", () => {
...
describe("director.md -- tool references", () => {
  ...
  it("references all 39 director tools", () => {
